...
class System{
    ...
    public function config(){
        ...
        $data['support'] = [
            ...
            'value' => [
                'name_1' => ['type' => 'text', 'label' => 'Tên hỗ trợ 1'],
                'phone_1' => ['type' => 'text', 'label' => 'Hotline hỗ trợ 1'],
                'zalo_1' => ['type' => 'text', 'label' => 'Link Zalo 1'],
                
                'name_2' => ['type' => 'text', 'label' => 'Tên hỗ trợ 2'],
                'phone_2' => ['type' => 'text', 'label' => 'Hotline hỗ trợ 2'],
                'zalo_2' => ['type' => 'text', 'label' => 'Link Zalo 2'],
                
                'name_3' => ['type' => 'text', 'label' => 'Tên hỗ trợ 3'],
                'phone_3' => ['type' => 'text', 'label' => 'Hotline hỗ trợ 3'],
                'zalo_3' => ['type' => 'text', 'label' => 'Link Zalo 3'],
                
                'name_4' => ['type' => 'text', 'label' => 'Tên hỗ trợ 4'],
                'phone_4' => ['type' => 'text', 'label' => 'Hotline hỗ trợ 4'],
                'zalo_4' => ['type' => 'text', 'label' => 'Link Zalo 4'],
                
                'name_5' => ['type' => 'text', 'label' => 'Tên hỗ trợ 5'],
                'phone_5' => ['type' => 'text', 'label' => 'Hotline hỗ trợ 5'],
                'zalo_5' => ['type' => 'text', 'label' => 'Link Zalo 5'],
            ]
        ];
