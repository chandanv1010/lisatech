...
class ProductRepository extends BaseRepository
{
    ...
    {
        return $this->model->with(['languages'])->where('publish', 2)->where('product_catalogue_id', $productCatalogueId)->where('id', '!=', $productId)->orderBy('id', 'desc')->limit($limit)->get();
    }
